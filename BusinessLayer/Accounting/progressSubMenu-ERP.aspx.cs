...
{
    public partial class progressSubMenu_ERP : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("addProgressPayment-ERP.aspx");
        }

        protected void editItemButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("editProgressPayment-ERP.aspx");
        }
        ...
        {
            Response.Redirect("listProgressPayment-ERP.aspx");
        }
    }
}