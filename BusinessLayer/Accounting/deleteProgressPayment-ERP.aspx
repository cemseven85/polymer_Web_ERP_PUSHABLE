<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="deleteProgressPayment-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.deleteProgressPayment_ERP" %>
    ...
    <div class="product-type">
        ...
        <div class="menu-item">
         ...
         <div class="menu-item-datalist" style="overflow: scroll">
            <asp:Panel ID="Show_Progress_Payment_Panel" runat="server" GroupingText="Progress Payment Module">
                ...
                <asp:GridView ID="jQueryRelated_Month_Progress_Payment_GridView" runat="server" DataKeyNames="earned_Salarie_ID,emp_ID, acct_ID,txn_Id_4P,txn_Id_4R" CssClass="product-type-gridview" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" OnPreRender="jQueryRelated_Month_Progress_Payment_GridView_PreRender" >
                    <Columns>
                ...
                <tr>                                      
                 ...
                 <tr>                                      
                    <td style="float:right">
                        <asp:Button ID="DeleteAllButton" runat="server" Text="DELETE Month"  Height="25px" Width="150" Font-Size="10pt" ForeColor="White" Font-Bold="true" BackColor="DarkRed" Visible="True" OnClientClick="return confirm('Are you sure you want to DELETE all Progress?');" OnClick="DeleteAllButton_Click"   />
                    </td>
                </tr>
            </table>
        </div>
                ...
                function pageLoad() {
                    createDataTable();
                      ...
                      function createDataTable() {
                          var table = $('#<%=jQueryRelated_Month_Progress_Payment_GridView.ClientID%>').DataTable(
                        {
                            bLengthChange: true,
