<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="txnDetailSubMenu-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.transactionDetailSubMenu_ERP" %>
    ...
    <div class="main" >
        <div class="menu-item" >
            ...
            <table class="item-table">
                ...
                <tr>
                    <td><p>Add Transaction Detail</p></td>
                </tr>
            </table>
            </asp:Panel></div>
        <div class="menu-item"  >
            <asp:Panel ID="editItem_Panel_" runat="server">
                ...
                <tr>
                    <td> <p>Edit Transaction Detail</p>   </td>
                </tr>
            </table>
            </asp:Panel></div>
        <div class="menu-item"  >
            <asp:Panel ID="deleteItem_Panel_" runat="server">
                ...
                <tr>
                    <td> <p>Delete Transaction Detail</p>   </td>
                </tr>
            </table>
            </asp:Panel></div>
        <div class="menu-item"  >
      ...
      <table class="item-table">
                ...
                <tr>
                    <td><p>List Transaction Detail</p></td>
                </tr>
            </table>               
            </asp:Panel></div>               
    </div>
