<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="editEmployee-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.edittEmployee_ERP" %>
    ...
    <div class="product-type">
            ...
            <asp:Panel ID="Product_Panel_10" runat="server" GroupingText="EMPLOYEE LIST">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQueryEmployeeGridView" runat="server" CssClass="product-type-gridview" OnPreRender="jQueryEmployeeGridView_PreRender" OnSelectedIndexChanged="jQueryEmployeeGridView_SelectedIndexChanged" ShowHeaderWhenEmpty="true" DataKeyNames="ID">
                                <Columns>
        ...
        <div class="menu-item">
            <table class="item-table">
                ...
                <tr>
                    <td>
                        <asp:Button ID="EditButton" runat="server" Text="EDIT" Height="50px" Width="300" Font-Size="20pt" Visible="True" OnClientClick="return confirm('Are you sure you want to edit this employee?');" OnClick="EditButton_Click" />
                    </td>
                </tr>
