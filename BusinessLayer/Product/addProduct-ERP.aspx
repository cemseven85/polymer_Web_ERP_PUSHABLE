<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="addProduct-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.addProduct_ERP" %>
     ...
     <div class="product-type">
        ...
        <div class="menu-item">
            <table class="item-table">
                ...
                <tr>
                    <td>
                        <asp:Button ID="prdAddButton" runat="server" Text="ADD" Height="50px" Width="300" Font-Size="20pt" Visible="True"   OnClientClick="return confirm('Are you sure you want to add this item?');" OnClick="prdAddButton_Click" />
                    </td>
                </tr>
            ...
            <asp:Panel ID="Product_Panel_10" runat="server" GroupingText="PRODUCT LIST">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQueryProductGridView" runat="server" CssClass="product-type-gridview"  ShowHeaderWhenEmpty="true" >
                    ...
                    createDataTable();
                      ...
                      function createDataTable() {
                          var table = $('#<%=jQueryProductGridView.ClientID%>').DataTable(
                        {
                          ...
                          $('#ContentPlaceHolder1_jQueryProductGridView tbody').on('click', 'tr', function () {
                              ...
                              message += "\nUnit: " + row.find("td").eq(5).html();
                              message += "\nVAT%: " + row.find("td").eq(6).html();
                              message += "\nWasteCode: " + row.find("td").eq(7).html();
                              message += "\nDescription: " + row.find("td").eq(8).html();
