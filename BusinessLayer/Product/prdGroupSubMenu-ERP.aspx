<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="prdGroupSubMenu-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.prdGroupSubMenu_ERP" %>
    ...
    <div class="main" >
        ...
        <div class="menu-item"  >
            <asp:Panel ID="deleteItem_Panel_" runat="server">
                ...
                <tr>
                    <td> <p>Delete Product Group</p>   </td>
                </tr>
            </table>
            </asp:Panel></div>
        <div class="menu-item"  >
