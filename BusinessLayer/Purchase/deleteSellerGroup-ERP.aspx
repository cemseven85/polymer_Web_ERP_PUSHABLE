<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="deleteSellerGroup-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.deleteSellerGroup_ERP" %>
     ...
     <div class="product-type">
        <asp:ScriptManager runat="server" />
         <div class="menu-item-datalist" style="overflow: scroll">
             <asp:Panel ID="Product_Panel_1" runat="server"  GroupingText="Seller Group List">
                 <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQuerySellerGroupGridView" runat="server" CssClass="product-type-gridview" OnPreRender="jQuerySellerGroupGridView_PreRender"  ShowHeaderWhenEmpty="true" >
                                <Columns>
