<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="addSeller-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.addSeller_ERP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="menu-item">
         ...
         <div class="menu-item">
            <table class="item-table">
                ...
                <tr>
                    <td>
                        <asp:Button ID="sellerAddButton" runat="server" Text="ADD" Height="50px" Width="300" Font-Size="20pt" Visible="True"   OnClientClick="return confirm('Are you sure you want to add this item?');" OnClick="AddButton_Click" />
                    </td>
                </tr>
            ...
            <asp:Panel ID="Product_Panel_10" runat="server" GroupingText="Seller List">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQuerySellerGridView" runat="server" CssClass="product-type-gridview"  ShowHeaderWhenEmpty="true" >
    ...
    <script type="text/javascript">
        ...
        function createDataTable() {
            ...
            $('#ContentPlaceHolder1_jQuerySellerGridView tbody').on('click', 'tr', function () {
                ...
                var message = "Selected Seller Details ";
