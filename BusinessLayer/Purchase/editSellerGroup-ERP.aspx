<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="editSellerGroup-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.edditSellerGroup_ERP" %>
            ...
            <asp:Panel ID="Product_Panel_10" runat="server" GroupingText="Seller Group List">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQuerySellerGroupGridView" runat="server" CssClass="product-type-gridview" OnPreRender="jQuerySellerGroupGridView_PreRender" OnSelectedIndexChanged="jQuerySellerGroupGridView_SelectedIndexChanged"  ShowHeaderWhenEmpty="true" >
                                <Columns>
