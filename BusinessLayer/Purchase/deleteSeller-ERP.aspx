<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="deleteSeller-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.deleteSeller_ERP" %>
            ...
            <asp:Panel ID="Product_Panel_10" runat="server" GroupingText="Seller List">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQuerySellerGridView" runat="server" CssClass="product-type-gridview" OnPreRender="jQuerySellerGridView_PreRender"  ShowHeaderWhenEmpty="true"  >
                                <Columns>
