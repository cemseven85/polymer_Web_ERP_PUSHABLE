...
{
    public partial class listSeller_ERP : System.Web.UI.Page
    {
        ...
        //    int numRows = jQuerySellerGridView.Rows.Count;   // Pulls number of Rows.
        //    int numColumns = jQuerySellerGridView.Rows[0].Cells.Count;   // Pulls number of Columns. 
        ...
        //    for (int i = 0; i < numColumns; i++)
        //    {
        //        worksheet.Cells[1, i + 1] = jQuerySellerGridView.HeaderRow.Cells[i].Text;   // By This Code We pull the Column Names
        //    }
        ...
        //        {
        //            worksheet.Cells[i + 2, j + 1] = jQuerySellerGridView.Rows[i].Cells[j].Text.Replace("&nbsp;"," ");
        //        }
        ...
        protected void ExcelButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var worksheet = package.Workbook.Worksheets.Add("SellerList");
                ...
                for (int i = 0; i < numColumns; i++)
                {
                    ...
                    worksheet.Cells[1, i + 1].Value = jQuerySellerGridView.HeaderRow.Cells[i].Text;
                }
                ...
                for (int i = 0; i < numRows; i++)
                {
                    for (int j = 0; j < numColumns; j++)
                    {
                        string cellValue = jQuerySellerGridView.Rows[i].Cells[j].Text.Replace("&nbsp;", " ");
                ...
                Response.AddHeader("content-disposition", "attachment; filename=SellerList.xlsx");
