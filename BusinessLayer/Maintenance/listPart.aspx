<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="listPart.aspx.cs" Inherits="polymer_Web_ERP_V4.BusinessLayer.Maintenance.listPart" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Part Type">
                            ...
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtPartType_Filter" runat="server" AutoPostBack="true" OnTextChanged="txtFilter_TextChanged" />
                            </HeaderTemplate>
                            <ItemTemplate>
