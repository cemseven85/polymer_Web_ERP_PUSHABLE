...
{
    public partial class listWProduction_ERP : System.Web.UI.Page
    {
        ...
        //    int numRows = jQueryInPutProductionGridView.Rows.Count;   // Pulls number of Rows.
        //    if (numRows > 0)
        //    {
        //        int numColumns = jQueryInPutProductionGridView.Rows[0].Cells.Count;   // Pulls number of Columns. 
        ...
        //        worksheet.Name = "Washing Production List";
        ...
        //        for (int i = 0; i < numColumns; i++)
        //        {
        //            worksheet.Cells[1, i + 1] = jQueryInPutProductionGridView.HeaderRow.Cells[i].Text;   // By This Code We pull the Column Names
        //        }
        ...
        //                {
        //                    tempValue = jQueryInPutProductionGridView.Rows[i].Cells[j].Text.Replace("&nbsp;", " ");
        ...
        //                else
        //                {
        //                    worksheet.Cells[i + 2, j + 1] = jQueryInPutProductionGridView.Rows[i].Cells[j].Text.Replace("&nbsp;", " ");
        //                }
        ...
        protected void ExcelButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var worksheet = package.Workbook.Worksheets.Add("Washing Production List");
                ...
                if (numRows > 0)
                {
                    ...
                    for (int i = 0; i < numColumns; i++)
                    {
                        ...
                        worksheet.Cells[1, i + 1].Value = jQueryInPutProductionGridView.HeaderRow.Cells[i].Text;
                    }
                    ...
                    for (int i = 0; i < numRows; i++)
                    {
                        for (int j = 0; j < numColumns; j++)
                        {
                            string cellValue = jQueryInPutProductionGridView.Rows[i].Cells[j].Text.Replace("&nbsp;", " ");
                    ...
                    Response.AddHeader("content-disposition", "attachment; filename=WashingProductionList.xlsx");
