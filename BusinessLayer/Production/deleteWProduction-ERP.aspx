<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="deleteWProduction-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.deleteWProduction_ERP" %>
            ...
            <asp:Panel ID="Product_Panel_4" runat="server" GroupingText="Production InPut List">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQueryInPutProductionGridView" runat="server" CssClass="product-type-gridviewS" ShowHeaderWhenEmpty="true" OnPreRender="jQueryScrapGridView_PreRender"  >
                                <Columns>
