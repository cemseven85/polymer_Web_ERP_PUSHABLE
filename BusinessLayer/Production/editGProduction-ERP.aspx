<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="editGProduction-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.editGProduction_ERP" %>
            ...
            <asp:Panel ID="Product_Panel_4" runat="server" GroupingText="Production OutPut List">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQueryOutPutProductionGridView" runat="server" CssClass="product-type-gridviewS" ShowHeaderWhenEmpty="true" OnPreRender="jQueryOutPutProductionGridView_PreRender" OnSelectedIndexChanged="jQueryOutPutProductionGridView_SelectedIndexChanged">
                                <Columns>
        ...
        <div class="menu-item">
            <table class="item-table">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="EditButton" runat="server" Text="EDIT" Height="30px" Width="150" Font-Size="15pt" Visible="True" OnClientClick="return confirm('Are you sure you want to run this Production?');" OnClick="EditButton_Click" />
                    </td>
                </tr>
            </table>
        </div>
