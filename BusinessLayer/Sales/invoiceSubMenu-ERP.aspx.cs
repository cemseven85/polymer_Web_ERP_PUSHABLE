...
{
    public partial class invoiceSubMenu_ERP : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("addInvoice-ERP.aspx");
        }

        protected void editItemButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("editInvoice-ERP.aspx");
        }
        ...
        {
            Response.Redirect("listInvoice-ERP.aspx");
        }
    }
}