<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="editInvoice-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.editInvoice_ERP" Culture="de-DE" UICulture="fr-FR" %>
                ...
                <table class="item-table">
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <asp:Button ID="editInvoiceButton" runat="server" Text="Edit Invoice" OnClientClick="return confirm('Are you sure you want to EDIT this invoice?');" OnClick="editInvoiceButton_Click" Height="51px" Width="118px" />
