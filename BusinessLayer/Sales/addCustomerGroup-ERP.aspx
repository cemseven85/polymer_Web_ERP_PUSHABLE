<%@ Page Title="" Language="C#" MasterPageFile="~/polymer_ERPV2.0.Master" AutoEventWireup="true" CodeBehind="addCustomerGroup-ERP.aspx.cs" Inherits="polymer_Web_ERP_V4.addCustomerGroup_ERP" %>
...
<div class="product-type">
        ...
        <div class="menu-item">
            <asp:Panel ID="Product_Group_Panel_4" runat="server">
                <table class="item-table">
                    <tr>
                        <td>
                            <asp:Label ID="Customer_Group_Name_TR_Label" runat="server" Text="Müşteri Grup Adı (TR)"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div class="menu-item">
            <table class="item-table">
                ...
                <tr>
                    <td>
                        <asp:Button ID="customerGroupAddButton" runat="server" Text="ADD" Height="50px" Width="300" Font-Size="20pt" Visible="True"   OnClientClick="return confirm('Are you sure you want to add this item?');" OnClick="AddButton_Click" />
                    </td>
                </tr>
            ...
            <asp:Panel ID="Product_Panel_10" runat="server">
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="jQueryCustomerGroupGridView" runat="server" CssClass="product-type-gridview"  ShowHeaderWhenEmpty="true">
                    ...
                    createDataTable();
                      ...
                      function createDataTable() {
                          var table = $('#<%=jQueryCustomerGroupGridView.ClientID%>').DataTable(
                        {
                          ...
                          $('#ContentPlaceHolder1_jQueryCustomerGroupGridView tbody').on('click', 'tr', function () {
                              ...
                              var message = "Selected Customer Group Details " ;
